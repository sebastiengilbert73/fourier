...
def main():
    ...
    reconstruction_odd = expander.reconstruct(a_n_odd, b_n_odd, 'odd', signal_length)
    reconstruction_even = expander.reconstruct(a_n_even, b_n_even, 'even', signal_length)
